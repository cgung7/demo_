...
public class RestControllerTest1 {
    ...
    // 테스트 주소 : https://jsonplaceholder.typicode.com/todos/1
...
//        RestTemplate restTemplate;
        ...
        URI uri = UriComponentsBuilder
                ...
                .path("/todos")
                .path("/" + id)
                .encode() // 주소에 한글이나 특수문자가 있는 경우 안전하게 변환
                .build()
                .toUri();
...
//        RestTemplate restTemplate;
    ...
    // 우리 서버에서는 GET 요청 맵핑 -> 다른 서버에 요청은 POST 요청.(정보 생성 방법)
    ...
    public ResponseEntity<?> test4() {
        ...
        // 브라우저 결과도 함께 출력
        return ResponseEntity.status(HttpStatus.OK).body(response.getBody().getBody());
    }
}
