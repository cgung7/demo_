-- insert into board_tb(title, content, user_id, created_at) values('제목1','내용1','ssar',now());
-- insert into board_tb(title, content, user_id, created_at) values('제목2','내용2','ssar',now());
-- insert into board_tb(title, content, user_id, created_at) values('제목3','내용3','cos',now());
-- insert into board_tb(title, content, user_id, created_at) values('제목4','내용4','love',now());
--
-- -- User 테이블 데이터 (5명의 사용자)
-- INSERT INTO user_tb (user_id, password, email, created_at) VALUES
